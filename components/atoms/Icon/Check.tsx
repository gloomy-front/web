...
const CheckIcon = (({ fill = '#BDBDBD', height = '24px', onClick, style }: SVGIconProps): ReactElement => (
  <svg
    height={height}
    viewBox="0 0 14 14"
    fill={fill}
